...
(cl:defmethod cl:initialize-instance :after ((m <Completed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Completed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name challenge1-msg:<Completed> is deprecated: use challenge1-msg:Completed instead.")))

(cl:ensure-generic-function 'completed-val :lambda-list '(m))
(cl:defmethod completed-val ((m <Completed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader challenge1-msg:completed-val is deprecated.  Use challenge1-msg:completed instead.")
  (completed m))
